...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    mysqli_query($koneksi, "INSERT INTO meja (nomor_meja, kapasitas) 
                            VALUES ('$nomor_meja', $kapasitas)");
...
// Count total paket
$total_meja = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) as total FROM meja"))['total'];
?>
...
<div class="page-header">
    <div class="page-title-wrapper">
        <div>
            ...
            <p class="page-subtitle">Kelola Meja reservasi untuk pelanggan café Anda</p>
        </div>
...
<div class="row g-4">
        ...
        <div class="glass-card">
            ...
            <div class="glass-card-body">
                ...
                <div class="tips-card">
                    ...
                    <p>Buat nama Meja yang menarik dan deskriptif. Contoh: "Meja" VIP", "Sofa Indoor", dll.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="glass-card">
            ...
            <div class="table-container">
                <table class="paket-table">
                    ...
                    <?php
                    $no = 1;
                    $q = mysqli_query($koneksi, "SELECT * FROM meja ORDER BY meja_id DESC");
                            ...
                            <td>
                                <div class="paket-name">
                                    ...
                                    <div class="paket-info">
                                        <h4><?= htmlspecialchars($d['nomor_meja']) ?></h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="price-display">
                                    ...
                                    <span class="amount"><?= number_format($d['kapasitas'], 0, ',', '.') ?></span>
                                </div>
                            </td>
                            <td class="text-center">
    <div class="action-buttons d-flex justify-content-center gap-2">
        ...
        <!-- EDIT -->
        <a href="dashboard.php?menu=meja_edit&id=<?= $d['meja_id'] ?>"
        ...
        <!-- HAPUS -->
        <a href="meja_hapus.php?id=<?= $d['meja_id'] ?>"
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="empty-state">
                                    ...
                                    <p>Tambahkan Meja reservasi pertama Anda</p>
                                </div>
                            </td>
                        </tr>
        ...
        Swal.fire({
            ...
            <div class="glass-card-footer">
                <div class="footer-info">
                    ...
                    Menampilkan <strong><?= $total_meja ?></strong> Meja
                </div>
            </div>
            <?php } ?>
        </div>
