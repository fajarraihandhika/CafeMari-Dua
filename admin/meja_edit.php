...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // SAMAKAN DENGAN INPUT FORM
    $id         = (int) $_POST['meja_id'];
...
$id = (int) $_GET['id']; // dari URL ?id=xx

$sql = mysqli_query($koneksi, "SELECT * FROM meja WHERE meja_id = $id");
...
?>
            ...
            <div class="glass-card-body">
                <form method="post" action="meja_update.php" id="formPaket">
                    <div class="form-group">
                        <label class="form-label">
                            <i data-lucide="tag"></i>
                            Nama Meja
                        </label>
                        <input type="hidden" name="id" value="<?= $d['meja_id'] ?>">
