...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    mysqli_query($koneksi, "INSERT INTO paket_reservasi (nama_paket, jumlah_orang, harga) 
...
// Count total paket
$total_paket = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) as total FROM paket_reservasi"))['total'];
?>
...
<div class="row g-4">
        ...
        <div class="glass-card">
            ...
            <div class="glass-card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-wrapper">
                            <input type="text" 
                                   name="nama_paket" 
                                   class="form-input" 
                                   placeholder="Contoh: Paket Romantic Dinner"
                                   required>
                ...
                <div class="tips-card">
                    ...
                    <p>Buat nama paket yang menarik dan deskriptif. Contoh: "Paket Anniversary", "Paket Birthday Special", dll.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="glass-card">
            ...
            <div class="table-container">
                <table class="paket-table">
                    ...
                    <?php
                    $no = 1;
                    $q = mysqli_query($koneksi, "SELECT * FROM paket_reservasi ORDER BY paket_id DESC");
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="paket-name">
                                    ...
                                    <div class="paket-info">
                                        <h4><?= htmlspecialchars($d['nama_paket']) ?></h4>
                                        <span>
                                            <i data-lucide="users"></i>
                                            <?= $d['jumlah_orang'] ?? '-' ?> Orang
                                        </span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="price-display">
                                    ...
                                    <span class="amount"><?= number_format($d['harga'], 0, ',', '.') ?></span>
                                </div>
                            </td>
                            <td class="text-center">
    <div class="action-buttons d-flex justify-content-center gap-2">
        ...
        <!-- EDIT -->
        <a href="dashboard.php?menu=paket_edit&id=<?= $d['paket_id'] ?>"
        ...
        <!-- HAPUS -->
        <a href="paket_hapus.php?id=<?= $d['paket_id'] ?>"
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="empty-state">
                                    ...
                                    <p>Tambahkan paket reservasi pertama Anda</p>
                                </div>
                            </td>
                        </tr>
        ...
        Swal.fire({
            ...
            <div class="glass-card-footer">
                <div class="footer-info">
                    ...
                    Menampilkan <strong><?= $total_paket ?></strong> paket
                </div>
            </div>
            <?php } ?>
        </div>
